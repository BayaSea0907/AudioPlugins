...
#if WINDOWS
AsioDriver::AsioDriver (LPUNKNOWN pUnk, HRESULT *phr) : CUnknown((TCHAR*)"My AsioDriver", pUnk, phr)
{
}
...
{
	// strcpy_s(string, "ASIO Driver Implementation Error!");
	string = (char*)"ASIO Driver Implementation Error!";
}
